...
public class Generate_Timesheet extends JFrame implements ActionListener {
	...
	Generate_Timesheet(){
		super("All Employee attendence Record");
		setSize(1480,400);
		setLocation(0,10);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getSource()==bt1) {
			new Generate_Timesheet_single(eid).setVisible(true);
		}
	}
