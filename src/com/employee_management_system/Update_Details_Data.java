			...
			public void mouseClicked(MouseEvent arg0) {
				try {
					...
					while(rest1.next()){
						...
						tf10.setText(rest1.getString("adhar"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==bt1) 
		{
			try {
				...
				String q1 = "Update employee set name='"+name+"',fname = '"+fname+"',age = '"+age+"',dob = '"+dob+"',address = '"+address+
						"',phone = '"+phone+"',email = '"+email+"',education = '"+education+"',job_post = '"+job_post+"',adhar = '"+adhar+"'where Eid='"+id+"'";
